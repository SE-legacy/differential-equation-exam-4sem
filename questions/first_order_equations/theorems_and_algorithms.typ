...
Рассмотрим ДУ вида $y' = f(x, y)$ и соответствующую ей задачу Коши. Предположим, что $f(x, y)$ и $(partial f(x, y)) / (partial y)$ непрерывные функции. Тогда задача Коши имеет единственное решение.
